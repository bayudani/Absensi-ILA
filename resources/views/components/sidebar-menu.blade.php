    ...
    <li>
        <a href="{{ route('dashboard') }}" 
           ...
           {{ request()->routeIs('dashboard') 
            ...
            <i class="fas fa-home w-5 h-5 transition duration-75 {{ request()->routeIs('dashboard') ? 'text-white' : 'text-gray-400 group-hover:text-emerald-600' }}"></i>
        ...
        <li>
            <a href="{{ route('guru.absensi.create') }}" 
               ...
               {{ request()->routeIs('guru.absensi.*') 
                  ? 'bg-emerald-600 text-white shadow-lg shadow-emerald-200' 
                  : 'text-gray-600 hover:bg-emerald-50 hover:text-emerald-600' }}">
                <i class="fas fa-check-circle w-5 h-5 transition duration-75 {{ request()->routeIs('guru.absensi.*') ? 'text-white' : 'text-gray-400 group-hover:text-emerald-600' }}"></i>
        ...
        <li>
            <a href="{{ route('guru.jadwal') }}" 
               ...
               {{ request()->routeIs('guru.jadwal*') 
                  ? 'bg-emerald-600 text-white shadow-lg shadow-emerald-200' 
                  : 'text-gray-600 hover:bg-emerald-50 hover:text-emerald-600' }}">
                <i class="fas fa-calendar w-5 h-5 transition duration-75 {{ request()->routeIs('guru.jadwal*') ? 'text-white' : 'text-gray-400 group-hover:text-emerald-600' }}"></i>
        ...
        <li>
            <a href="{{ route('guru.rekap') }}" 
               ...
               {{ request()->routeIs('guru.rekap*') 
                  ? 'bg-emerald-600 text-white shadow-lg shadow-emerald-200' 
                  : 'text-gray-600 hover:bg-emerald-50 hover:text-emerald-600' }}">
                <i class="fas fa-chart-bar w-5 h-5 transition duration-75 {{ request()->routeIs('guru.rekap*') ? 'text-white' : 'text-gray-400 group-hover:text-emerald-600' }}"></i>
        ...
        <li>
            <a href="{{ route('walas.laporan') }}" 
               ...
               {{ request()->routeIs('walas.laporan*') 
                  ? 'bg-emerald-600 text-white shadow-lg shadow-emerald-200' 
                  : 'text-gray-600 hover:bg-emerald-50 hover:text-emerald-600' }}">
                <i class="fas fa-file-alt w-5 h-5 transition duration-75 {{ request()->routeIs('walas.laporan*') ? 'text-white' : 'text-gray-400 group-hover:text-emerald-600' }}"></i>
        ...
        <li>
            <a href="{{ route('kepsek.monitoring') }}" 
               ...
               {{ request()->routeIs('kepsek.monitoring*') 
                  ? 'bg-emerald-600 text-white shadow-lg shadow-emerald-200' 
                  : 'text-gray-600 hover:bg-emerald-50 hover:text-emerald-600' }}">
                <i class="fas fa-chart-line w-5 h-5 transition duration-75 {{ request()->routeIs('kepsek.monitoring*') ? 'text-white' : 'text-gray-400 group-hover:text-emerald-600' }}"></i>
